...
def test_bip84_from_seed_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        seed=BIP39Seed(
            seed=data["hdwallet"]["BIP84"]["compressed"]["seed"]
        )
    ).from_derivation(
...
def test_bip84_from_seed_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        seed=BIP39Seed(
            seed=data["hdwallet"]["BIP84"]["uncompressed"]["seed"]
        )
    ).from_derivation(
        derivation=DERIVATIONS.derivation(data["hdwallet"]["BIP84"]["derivation"]["name"])(
            **data["hdwallet"]["BIP84"]["derivation"]["args"]
