...
def test_bip86_from_seed_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        seed=BIP39Seed(
            seed=data["hdwallet"]["BIP86"]["compressed"]["seed"]
        )
    ).from_derivation(
...
def test_bip86_from_seed_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        seed=BIP39Seed(
            seed=data["hdwallet"]["BIP86"]["uncompressed"]["seed"]
        )
    ).from_derivation(
        derivation=DERIVATIONS.derivation(data["hdwallet"]["BIP86"]["derivation"]["name"])(
            **data["hdwallet"]["BIP86"]["derivation"]["args"]
