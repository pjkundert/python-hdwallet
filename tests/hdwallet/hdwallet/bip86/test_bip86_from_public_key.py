...
def test_bip86_from_public_key_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        public_key=data["hdwallet"]["BIP86"]["compressed"]["derivations"][-1]["public_key"]
    )
...
def test_bip86_from_public_key_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        public_key=data["hdwallet"]["BIP86"]["uncompressed"]["derivations"][-1]["public_key"]
    )
