...
def test_bip86_from_xprivate_key_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xprivate_key=data["hdwallet"]["BIP86"]["compressed"]["root_xprivate_key"],
        strict=data["hdwallet"]["BIP86"]["compressed"]["strict"]
    ).from_derivation(
...
def test_bip86_from_xprivate_key_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xprivate_key=data["hdwallet"]["BIP86"]["uncompressed"]["root_xprivate_key"],
        strict=data["hdwallet"]["BIP86"]["uncompressed"]["strict"]
    ).from_derivation(
        derivation=DERIVATIONS.derivation(data["hdwallet"]["BIP86"]["derivation"]["name"])(
            **data["hdwallet"]["BIP86"]["derivation"]["args"]
        )
