...
def test_shelley_icarus_from_xprivate_key(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xprivate_key=data["hdwallet"]["Cardano"]["shelley-icarus"]["root_xprivate_key"],
        strict=data["hdwallet"]["Cardano"]["shelley-icarus"]["strict"]
    ).from_derivation(
