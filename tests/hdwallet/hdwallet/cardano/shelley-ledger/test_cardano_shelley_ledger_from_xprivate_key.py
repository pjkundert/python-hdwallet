...
def test_shelley_ledger_from_xprivate_key(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        xprivate_key=data["hdwallet"]["Cardano"]["shelley-ledger"]["root_xprivate_key"],
        strict=data["hdwallet"]["Cardano"]["shelley-ledger"]["strict"]
    ).from_derivation(
