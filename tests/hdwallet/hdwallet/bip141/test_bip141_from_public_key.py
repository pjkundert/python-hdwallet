...
def test_bip141_from_public_key_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        public_key=data["hdwallet"]["BIP141"]["compressed"]["derivations"][-1]["public_key"]
    )
...
def test_bip141_from_public_key_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        public_key=data["hdwallet"]["BIP141"]["uncompressed"]["derivations"][-1]["public_key"]
    )
