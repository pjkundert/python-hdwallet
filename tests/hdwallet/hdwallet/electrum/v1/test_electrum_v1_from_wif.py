...
def test_electrum_v1_from_wif_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        wif=data["hdwallet"]["Electrum-V1"]["compressed"]["master_wif"]
    ).from_derivation(
...
def test_electrum_v1_from_wif_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        wif=data["hdwallet"]["Electrum-V1"]["uncompressed"]["master_wif"]
    ).from_derivation(
        derivation=DERIVATIONS.derivation(data["hdwallet"]["Electrum-V1"]["derivation"]["name"])(
            **data["hdwallet"]["Electrum-V1"]["derivation"]["args"]
        )
