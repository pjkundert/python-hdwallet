...
def test_electrum_v1_from_seed_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        seed=ElectrumV1Seed(
            seed=data["hdwallet"]["Electrum-V1"]["compressed"]["seed"]
        )
    ).from_derivation(
...
def test_electrum_v1_from_seed_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        seed=ElectrumV1Seed(
            seed=data["hdwallet"]["Electrum-V1"]["uncompressed"]["seed"]
        )
    ).from_derivation(
        derivation=DERIVATIONS.derivation(data["hdwallet"]["Electrum-V1"]["derivation"]["name"])(
            **data["hdwallet"]["Electrum-V1"]["derivation"]["args"]
