...
from hdwallet.mnemonics import ElectrumV1Mnemonic
from hdwallet.hds import HDS


def test_electrum_v1_from_mnemonic_compressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        mnemonic=ElectrumV1Mnemonic(
            mnemonic=data["hdwallet"]["Electrum-V1"]["compressed"]["mnemonic"]
        )
    ).from_derivation(
...
def test_electrum_v1_from_mnemonic_uncompressed(data):
    ...
    hdwallet: HDWallet = HDWallet(
        ...
        mnemonic=ElectrumV1Mnemonic(
            mnemonic=data["hdwallet"]["Electrum-V1"]["uncompressed"]["mnemonic"]
        )
    ).from_derivation(
        derivation=DERIVATIONS.derivation(data["hdwallet"]["Electrum-V1"]["derivation"]["name"])(
            **data["hdwallet"]["Electrum-V1"]["derivation"]["args"]
